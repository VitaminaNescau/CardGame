...
//perseu
gotoxy(seu, 4 );
writeln('MBBBBBBBBBBBBBBBMMMMBBBBBBMBBBMGMBMMMBMBM2rr:rrrr');
 gotoxy(seu, 5 );
writeln('BBBBBBBBBBBBBBBBBBBBBBX,      sBBBBBBBBBBBG25S2ss ');
 gotoxy(seu, 6 );
writeln('BBB:sBMBMMMMMMMBMBMBB           :BBBBBBBBBM2ssss2');
gotoxy(seu, 7 );
writeln('MBB: BBBMMMBMBMMMBBMBM            BBBBBBBBB5r2ss2 ');
gotoxy(seu, 8 );
writeln('MBBh sBBBBMMMMMBBBMBBBs       ,   iBM::::sBG:rrss ');
gotoxy(seu, 9 );
writeln('MBBB  2BBMMBBBBBBBBBBBBMs ,,  ,r  ,B9:iriirrirrrs ');
 gotoxy(seu, 10 );
writeln('MBBB   BBBBBBBM99M9GBBBBG52MB  i  BBGsirrrirrrrrs ');
 gotoxy(seu, 11 );
writeln('MBBBs  ,BMGG9Ssiii::i2Ms r9rGs    G22srsrrrrrrsrs ');
gotoxy(seu, 12);
writeln('MB9MB   SG522S5hh2r::ii, ,si2M, ,Gsiirrrrrrssrrss');
 gotoxy(seu, 13 );
writeln('s2ssGi   B9255hSX52ssrs,   r2X, r isrrsssssrsssrs ');
 gotoxy(seu, 14 );
writeln('BBMMhGs  2MX5h2SSSShXSG9       ,   rsssssssssssrs');
 gotoxy(seu, 15 );
writeln('BBBBBBMs  Bh222252S2299         ,ssssrssrsrrsrsss');
 gotoxy(seu, 16 );
writeln('BBBBBBBB, sMSX2222222G:          ,i2sssssssssssss');
gotoxy(seu, 17 );
writeln('BBBBBBBBB  M92222222SG             92ssssssssssss');
gotoxy(seu, 18 );
writeln('BBBBBBBBB: rMX25222sS9 ,,           sssrrssssssss ');
 gotoxy(seu, 19 );
writeln('BBBBBBBBBB  Mh25XXGBB2  :            2ssrrsssssss');
 gotoxy(seu, 20 );
writeln('GM9BBBBBBB5 :Mh9Mhsi    :     ,Msir25G9hh2srrssss');
 gotoxy(seu, 21 );
writeln('GBG99BBBBB9  BBs       BB:     GMMMGGhhhhG9hsrsss ');
 gotoxy(seu, 22);
writeln('GBGMGGMBBB29       ,sBBBBi:   rB999hhhhhhhh9G2rs2 ');
 gotoxy(seu, 23);
writeln('GBGGGGG9GMBB   BBBBBBBGi     sBh9hS5XSXShXhS9Gsis ');
gotoxy(seu, 24);
writeln('GBGGGMGGGMBh, SBBBBG,,      ,B9hSS5hShhXSXh9SS5rr ');
gotoxy(seu, 25);
writeln('9M99G99GMMBBMBBBM2:         hBhhh5hhh5hXh9X22sssr ');
 gotoxy(seu, 26 );
writeln('MBBBMMMMhShMBBGs            MGXhSXhhhhhhhS22ssssr');
gotoxy(seu, 27);
writeln('BBBBBBB5ssssi               MM95ShSShh9S52ssssrri ');
gotoxy(seu, 28);
writeln('BBBBBBBBBBBB                2BXhXS5XSSS2ssssssiss ');
gotoxy(seu, 29);
writeln('BBBBBBBBBBBB     s99G9,      BGXX5hXhX2sssssri:s9');
gotoxy(seu, 30);

writeln('BBBBBBBBBBBB    hGssss22i,   :BMhhhh2ssssssri:r25 ');
gotoxy(seu, 31);
writeln('BBBBBBBBBBBB r  9Msrsssrrss2s :BM9S22sssrri::r225');
gotoxy(seu, 32);
writeln('BBBBBBBBBBBB9:  2srSBBBB992s2,  2GM9ssssri::sS222');
gotoxy(seu, 33);
writeln(',sBBGhMBBBBBB,  BSisBBBBBBBBBh     :2srris5h9S2s2 ');
gotoxy(seu, 34);
writeln('   9BBBMBBBBB5  MBsir9BBBBBBBBGr     sriirssr:isS ');
 gotoxy(seu, 35 );                                        
writeln('    ,r5MMBBBBB  rBMhss9MBBBBBBBB9     srii:,:SBBB ');
 gotoxy(seu, 36);
writeln('           ,sB2  B99G9X2SMMBMBBBBs::   r,:,,,BBBB');
gotoxy(seu, 37);
writeln('             s  BBBBBBBBMMMGBBBBBBBB, BGSssiGBBB ');
